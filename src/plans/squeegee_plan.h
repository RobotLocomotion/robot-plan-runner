 ...
 */
class SqueegeePlan : public PlanBase {
 public:
  SqueegeePlan(drake::trajectories::PiecewiseQuaternionSlerp<double> quat_traj,
 ...
 private:
  ...
  double roll_TC_desired_;
  mutable double roll_TC_now_;
  mutable double roll_previous_;  
  double kp_;
