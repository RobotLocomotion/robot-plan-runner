...
class HybridTrajectoryPlan : public PlanBase {
public:
  HybridTrajectoryPlan(
    ...
    threads_["subscribe_force_torque"] = 
      std::thread(&HybridTrajectoryPlan::SubscribeForceTorque, this);
    threads_["subscribe_velocity"] = 
      std::thread(&HybridTrajectoryPlan::SubscribeVelocity, this);      
    threads_["subscribe_pose"] = 
      std::thread(&HybridTrajectoryPlan::SubscribePose, this);
