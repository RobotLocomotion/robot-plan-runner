...
def test_joint_space_plan_abort():
...
def test_joint_space_plan_loop():
    """
...
if __name__ == "__main__":
    ...
    test_lst = [
        test_joint_space_plan,
        test_joint_space_plan_abort,
        test_task_space_plan,
        test_joint_space_plan_loop,
    ]
